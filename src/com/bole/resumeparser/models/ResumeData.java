...
//	private String weibo; //个人微博
	...
	private Date update_time;   //简历更新时间的date格式 便于es的检索
	...
	private boolean isPhonePub = true;   //电话号码是否公开
	private boolean isEmailPub = true;    //邮箱是否公开
	private boolean isNamePub = true;      //姓名是否公开
...
//	private String email; // email
	...
	// 记录用户自定义的标题段
	private HashMap<String,String> otherInfoMap = new HashMap<String,String>(); 
	...
	//个人联系信息
	public ContactInfoData contactInfoData = new ContactInfoData();
	...
	public boolean isPhonePub() {
		return isPhonePub;
	}
	public void setPhonePub(boolean isPhonePub) {
		this.isPhonePub = isPhonePub;
	}
	public boolean isEmailPub() {
		return isEmailPub;
	}
	public void setEmailPub(boolean isEmailPub) {
		this.isEmailPub = isEmailPub;
	}
	public boolean isNamePub() {
		return isNamePub;
	}
	public void setNamePub(boolean isNamePub) {
		this.isNamePub = isNamePub;
	}
